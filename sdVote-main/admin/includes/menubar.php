<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="trans.php"><i class="glyphicon glyphicon-random"></i> <span>Transactions</span></a></li>
	   <li class=""><a href="chain.php"><i class="fa fa-chain"></i> <span>Chain</span></a></li>
